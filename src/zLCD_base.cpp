...
uint16_t zLCD_base::utf8(uint8_t char_utf_8_data)
{
...
/*
uint16_t zLCD_base::cp1251(uint16_t char_cp1251_data)
{
    char_cp1251_data -= 32;
...
size_t zLCD_base::write(uint8_t character)
{
    bool start = false;
...
void zLCD_base::write_char(uint16_t character)
{
    character -= 32;
    uint8_t temp_data;
    ...
    Serial1.println(font_data[count_var],BIN);
    */
...
void zLCD_base::setFont(uint8_t* data)
{
...
void zLCD_base::invertingText(bool _inverting_text, bool _inverting_space)
{
    inverting_text = _inverting_text;
    inverting_space = _inverting_space;
}

void zLCD_base::drawText(uint8_t x, uint8_t y, char* data)
{
    count_char = 0;
    font_x = x;
    font_y = y;
...
void zLCD_base::drawText(uint8_t x, uint8_t y, const String &data)
{
    count_char = 0;
    font_x = x;
    font_y = y;
...
void zLCD_base::drawText(uint8_t x, uint8_t y, const char data[])
{
    count_char = 0;
    font_x = x;
    font_y = y;
...
void zLCD_base::drawText(uint8_t x, uint8_t y, uint8_t data)
{
    count_char = 0;
    font_x = x;
    font_y = y;
...
void zLCD_base::drawText(uint8_t x, uint8_t y, int data)
{
    count_char = 0;
    font_x = x;
    font_y = y;
...
void zLCD_base::drawText(uint8_t x, uint8_t y, unsigned int data)
{
    count_char = 0;
    font_x = x;
    font_y = y;
...
void zLCD_base::drawText(uint8_t x, uint8_t y, long data)
{
    count_char = 0;
    font_x = x;
    font_y = y;
...
void zLCD_base::drawText(uint8_t x, uint8_t y, unsigned long data)
{
    count_char = 0;
    font_x = x;
    font_y = y;
...
void zLCD_base::drawText(uint8_t x, uint8_t y, long long data)
{
    count_char = 0;
    font_x = x;
    font_y = y;
...
void zLCD_base::drawText(uint8_t x, uint8_t y, unsigned long long data)
{
    count_char = 0;
    font_x = x;
    font_y = y;
...
void zLCD_base::drawText(uint8_t x, uint8_t y, double data)
{
    count_char = 0;
    font_x = x;
    font_y = y;
...
void zLCD_base::drawText(uint8_t x, uint8_t y, const __FlashStringHelper *data)
{
    count_char = 0;
    font_x = x;
    font_y = y;
...
void zLCD_base::drawText(uint8_t x, uint8_t y, const Printable &data)
{
    count_char = 0;
    font_x = x;
    font_y = y;
...
void zLCD_base::resumeDrawText(char* data)                         {  print(data); }
void zLCD_base::resumeDrawText(const String & data)                {  print(data); }
void zLCD_base::resumeDrawText(char data)                          {  print(data); }
void zLCD_base::resumeDrawText(const char data[])                  {  print(data); }
void zLCD_base::resumeDrawText(uint8_t data)                       {  print(data); }
void zLCD_base::resumeDrawText(int data)                           {  print(data); }
void zLCD_base::resumeDrawText(unsigned int data)                  {  print(data); }
void zLCD_base::resumeDrawText(long data)                          {  print(data); }
void zLCD_base::resumeDrawText(unsigned long  data)                {  print(data); }
#if not defined (__AVR__)
void zLCD_base::resumeDrawText(long long data)                     {  print(data); }
void zLCD_base::resumeDrawText(unsigned long long data)            {  print(data); }
#endif
void zLCD_base::resumeDrawText(double data)                        {  print(data); }
void zLCD_base::resumeDrawText(const __FlashStringHelper * data)   {  print(data); }
void zLCD_base::resumeDrawText(const Printable& data)              {  print(data); }

void zLCD_base::drawPixel(uint8_t x, uint8_t y, uint8_t pixel)
{
    if (x <= 127 && y <= 63) {
        uint8_t x_byte = x/8 ;
        uint8_t x_bit = x%8;
        ...
        if(pixel){ // if pixel = 1
            //Serial1.println("pixel1");
            frame_buffer[y][x_byte] |= (1 << (7 - x_bit));
        }
        else { // if pixel not = 1
            //Serial1.println("pixel0");
            frame_buffer[y][x_byte] &= ~(1 << (7 - x_bit));
        }
    }
}

void zLCD_base::drawHLine(uint8_t x, uint8_t y, uint8_t end_line, uint8_t line_width, uint8_t pixel)
{
...
void zLCD_base::drawVLine(uint8_t x, uint8_t y, uint8_t end_line, uint8_t line_width, uint8_t pixel)
{
    for (int i = 0; i < end_line; i++) {
        for (int i2 = 0; i2 < line_width; i2++) {
...
void zLCD_base::drawBox(uint8_t x, uint8_t y, uint8_t end_x, uint8_t end_y, uint8_t border_width, uint8_t pixel)
{
...
void zLCD_base::drawFillBox(uint8_t x, uint8_t y, uint8_t end_x, uint8_t end_y, uint8_t pixel)
{
    drawHLine(x, y, end_x, end_y , pixel);
}

void zLCD_base::drawCircle(uint8_t x, uint8_t y, uint8_t radius, uint8_t pixel)
{
    /*из wikipedia*/
    int x0 = x;
    int y0 = y;
...
void zLCD_base::drawFillCircle(uint8_t x, uint8_t y, uint8_t radius, uint8_t pixel)
{
    int x0 = radius;
    int y0 = 0;
...
void zLCD_base::drawBitmap(uint8_t x, uint8_t y, float size_x, uint8_t size_y, uint8_t *bitmap_buffer, uint8_t pixel)
{
    uint8_t x_byte = x/8 ;
    uint8_t x_bit = x%8;
